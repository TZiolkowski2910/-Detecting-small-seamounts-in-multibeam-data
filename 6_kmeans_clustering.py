...
for model_name in models:
    ...
    print(f"KMeans Clusterverteilung für {model_name}: {dict(zip(unique, counts))}")

    visualize_clusters(input_img_paths, labels, 'KMeans', model_name)

    # Visualisiere alle Bilder in jedem Cluster
 #   for cluster in range(5):
 #       plot_all_images_in_cluster(input_img_paths, labels, cluster, 'KMeans', model_name)
